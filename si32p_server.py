...
def is_command_recognized(msg) -> bool:
    ...
    all_cmd = [si32p.SI32P_CLI_HELLO, si32p.SI32P_CLI_INVERT, si32p.SI32P_CLI_LOWERCASE, si32p.SI32P_CLI_BYE]
...
def cmd_lowercase(msg: str) -> str:
    '''
    Implements the string in lowercase
    '''
    low = msg.lower()
    print(f'convert low method - - - - {low}')
    return msg.lower()
